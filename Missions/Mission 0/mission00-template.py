...
# final answer: Missing parenthesis in call to print
...
# print(red == 44)
# expected answer: error
# final answer: name 'red' is not defined
...
# print(red = 44)
# expected answer: error
# final answer: 'red' is an invalid keyword argument for this function
...
##from PIL import *
##expected answer: I don't know what to expect. Nothing?
