...
def flatten(tree):
    ...
    if is_empty_tree(tree) == True:
        ...
        if is_empty_tree(left_branch(left_branch(tree))) == False or is_empty_tree(right_branch(left_branch(tree))) == False:
            flatten(left_branch(tree))
        else:
            flat += [entry(tree)]
            if is_empty_tree(left_branch(right_branch(tree))) == False or is_empty_tree(right_branch(right_branch(tree))) == False:
                flatten(right_branch(tree))
    return []
